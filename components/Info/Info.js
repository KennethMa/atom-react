        ...
        return (
            <div key={i}>
                ...
                <div className="intro">
                    ...
                    <div className="row">
                        <div id="quanzi" className="col-lg-6 col-md-6 col-sm-6 col-xs-6 tar">
                            圈子：
                            <img className="img-circle" src={info.quanziImg} alt="" width="20px" height="20px"/>
                            <span>&nbsp;{info.quanziName}</span>
                        </div>
                        <div id="quanzhu" className="col-lg-6 col-md-6 col-sm-6 col-xs-6 tal bl">
                            圈主：
                    ...
                    <div className="row">
                        <div id="words" className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <p>{info.description}</p>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 tar">
                            <i className="glyphicon glyphicon-fire" style={{"color": "#ff7200"}}></i>&nbsp;{info.fire}
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 tal bl">
